...
class User(object):
    ...
    def __init__(self, email=None, full_name=None, organization_id=None, n_pipelines_executed=0, firebase_id=None, id=None, created_at=None, role_id=None):  # noqa: E501
