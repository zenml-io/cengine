...
from ce_standards.standard_experiment import GlobalKeys, SplitKeys
...
#
#   - categorize_by:    A dictionary containing the options for a categorical split
#   - index_by:         A dictionary containing the options for an index-based split
#   - ratio:            A dictionary specifying a common percentage-based splitting
#                       approach for both categorical and index-based splits (if given)
...
#                               configurations
#
# for more info: https://docs.maiot.io/training-1/set-up-your-model-for-training
"""),
    (GlobalKeys.PREPROCESSING, """
